const mapNextAds = [
	"https://app.pahe.my.id/costom-botton-shoope.js",
	"https://app.pahe.my.id/main.js",
	"https://app.pahe.my.id/detect-click.js"
];
...
(async ()=>{
	const urlOpenClick = "https://t.co/8RJWNNuJYI";

	//-- direct link adsterra
	let urlOpenClick2 = "https://readydolphinpoverty.com/uijctn538c?key=4f219c1087bce980ac7a203a864c9d2b";

	await initBannerJs("https://www.adscontrol.xyz/sweetalert2.min.js");
	await initBannerCss("https://www.adscontrol.xyz/sweetalert2.min.css");

		Swal.fire({
		  title: "",
		  html:`<img src="https://odong.eduzone.my.id/7.7MegaElektronikSale.jpg" />`,
		  //html:htmlOpen,
